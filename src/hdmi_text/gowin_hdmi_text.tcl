...
# ============================================================
# 使い方: CmCPU ルートで実行: gw_sh src/hdmi_text/gowin_hdmi_text.tcl
# ============================================================
...
set cst_file "${project_root}/src/hdmi_text/tang_console_138k_hdmi_text.cst"
...
if { [catch {create_project -name check_dev -dir $check_dir -pn $device_pn -device_version $device_version -force} msg] } {
    ...
    set cst_file "${project_root}/src/hdmi_text/tang_console_138k_hdmi_text_pg484.cst"
    set is_fallback 1
} else {
