# ============================================================
# Gowin EDA Tcl スクリプト: UART Hello SV → FS 変換
# ============================================================
# 使い方: CmCPU ルートで実行: gw_sh src/uart/gowin_build.tcl
# ============================================================
...
# ファイルパス（絶対パスで指定）
set sv_file "${project_root}/build/uart_hello.sv"
set cst_file "${project_root}/src/uart/tang_console_138k.cst"
set output_dir "${project_root}/build"
set project_name "uart_hello"
...
set_option -top_module uart_hello
set_option -output_base_name uart_hello
